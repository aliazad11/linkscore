...
const EXTRA = {
  en: { badge_step3: "Step 3 of 3", q_counter: "Question {n} of {m}", pdf_upload_cta: "Upload PDF (recommended, 30 seconds)", skip_preliminary: "Skip if you must, your score will be marked preliminary.", ss_post: "Post {n}", ss_post_uploaded: "Post {n} uploaded", gen_title: "Almost there...", gen_sub: "Generating your personalized plan.", link_not_found: "Link Not Found", noun_deal: "deal", noun_customer: "customer", noun_project: "project", noun_client: "client" },
  de: { badge_step3: "Schritt 3 von 3", q_counter: "Frage {n} von {m}", pdf_upload_cta: "PDF hochladen (empfohlen, 30 Sekunden)", skip_preliminary: "Überspringen, wenn es sein muss. Dein Score gilt dann als vorläufig.", ss_post: "Beitrag {n}", ss_post_uploaded: "Beitrag {n} hochgeladen", gen_title: "Fast geschafft...", gen_sub: "Ihr personalisierter Plan wird erstellt.", link_not_found: "Link nicht gefunden", noun_deal: "Abschluss", noun_customer: "Kunde", noun_project: "Projekt", noun_client: "Kunde" },
  fr: { badge_step3: "Étape 3 sur 3", q_counter: "Question {n} sur {m}", pdf_upload_cta: "Importer le PDF (recommandé, 30 secondes)", skip_preliminary: "Passez si nécessaire. Votre score sera alors marqué comme préliminaire.", ss_post: "Post {n}", ss_post_uploaded: "Post {n} importé", gen_title: "Presque terminé...", gen_sub: "Génération de votre plan personnalisé.", link_not_found: "Lien introuvable", noun_deal: "contrat", noun_customer: "client", noun_project: "projet", noun_client: "client" },
  es: { badge_step3: "Paso 3 de 3", q_counter: "Pregunta {n} de {m}", pdf_upload_cta: "Subir PDF (recomendado, 30 segundos)", skip_preliminary: "Sáltalo si es necesario. Tu puntuación se marcará como preliminar.", ss_post: "Publicación {n}", ss_post_uploaded: "Publicación {n} subida", gen_title: "Casi listo...", gen_sub: "Generando tu plan personalizado.", link_not_found: "Enlace no encontrado", noun_deal: "operación", noun_customer: "cliente", noun_project: "proyecto", noun_client: "cliente" },
  pt: { badge_step3: "Etapa 3 de 3", q_counter: "Pergunta {n} de {m}", pdf_upload_cta: "Carregar PDF (recomendado, 30 segundos)", skip_preliminary: "Salta se for preciso. A tua pontuação ficará marcada como preliminar.", ss_post: "Publicação {n}", ss_post_uploaded: "Publicação {n} enviada", gen_title: "Quase lá...", gen_sub: "Gerando o seu plano personalizado.", link_not_found: "Link não encontrado", noun_deal: "negócio", noun_customer: "cliente", noun_project: "projeto", noun_client: "cliente" },
  nl: { badge_step3: "Stap 3 van 3", q_counter: "Vraag {n} van {m}", pdf_upload_cta: "PDF uploaden (aanbevolen, 30 seconden)", skip_preliminary: "Sla over als het moet. Je score wordt dan als voorlopig gemarkeerd.", ss_post: "Post {n}", ss_post_uploaded: "Post {n} geüpload", gen_title: "Bijna klaar...", gen_sub: "Je gepersonaliseerde plan wordt gegenereerd.", link_not_found: "Link niet gevonden", noun_deal: "deal", noun_customer: "klant", noun_project: "project", noun_client: "klant" },
  it: { badge_step3: "Passaggio 3 di 3", q_counter: "Domanda {n} di {m}", pdf_upload_cta: "Carica il PDF (consigliato, 30 secondi)", skip_preliminary: "Salta se proprio devi. Il tuo punteggio sarà segnato come preliminare.", ss_post: "Post {n}", ss_post_uploaded: "Post {n} caricato", gen_title: "Ci siamo quasi...", gen_sub: "Generazione del tuo piano personalizzato.", link_not_found: "Link non trovato", noun_deal: "affare", noun_customer: "cliente", noun_project: "progetto", noun_client: "cliente" },
};
const DICT = {};
