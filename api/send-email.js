...
export default async function handler(req) {
  ...
  try {
      ...
      <body style="margin:0;padding:0;background:#ffffff;font-family:'Segoe UI',sans-serif;">
        <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
            <img src="https://raw.githubusercontent.com/aliazad11/linkscore/main/logo-dark.png" alt="Linkedscore" style="height:36px;margin-bottom:32px;display:block;" />
                <h1 style="color:#111827;font-size:26px;font-weight:800;margin-bottom:8px;">${firstName}, you are <span style="color:#c8a96e;">${plan.archetype}</span></h1>
                    <p style="color:#6b7280;font-size:15px;line-height:1.6;margin-bottom:32px;">${plan.headline}</p>
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:16px;padding:24px;margin-bottom:24px;">
                              <p style="color:#c8a96e;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:8px;">YOUR LINKEDIN SCORE</p>
                                    <p style="color:#111827;font-size:48px;font-weight:800;margin:0 0 8px;">${plan.score}<span style="font-size:20px;color:#6b7280;">/100</span></p>
                                                              ...
                                                              <ul style="list-style:none;padding:0;margin:0;">${hooks}</ul>
                                                                      ...
                                                                      <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:16px;padding:24px;margin-bottom:32px;">
                                                                            <p style="color:#c8a96e;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:16px;">3 CRITICAL RULES</p>
                                                                                  <ul style="color:#374151;font-size:14px;line-height:1.6;padding-left:20px;">${rules}</ul>
                                                                                      </div>
                                                                                          <a href="https://linkedscore.app" style="display:block;text-align:center;background:linear-gradient(135deg,#c8a96e,#a07840);color:#ffffff;text-decoration:none;padding:16px;border-radius:14px;font-weight:700;font-size:15px;margin-bottom:24px;">View Your Full Plan →</a>
                                                                                              <p style="color:#9ca3af;font-size:12px;text-align:center;">You received this because you used Linkedscore.<br/>© 2025 Linkedscore</p>
                                                                                                </div>
                                                                                                </body>
                                                                                                </html>`;
